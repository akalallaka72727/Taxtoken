...
// ── ENV validation ────────────────────────────────────────────────────────────
const REQUIRED_ENV = ["BOT_TOKEN", "RPC_URL", "MINT_AUTHORITY_SECRET", "PINATA_JWT"];
...
const payer = Keypair.fromSecretKey(bs58.decode(process.env.MINT_AUTHORITY_SECRET));

// If separate withdraw authority is set, use it; otherwise payer doubles as authority
const withdrawAuthority = process.env.WITHDRAW_WITHHELD_SECRET
  ? Keypair.fromSecretKey(bs58.decode(process.env.WITHDRAW_WITHHELD_SECRET))
  : payer;
